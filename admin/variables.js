var game =JSON.stringify({'name':'Game Engine','description':'Game pour une application'});

var level = new Array();
level[0] =JSON.stringify({'name':'Level nerd','description':'Levels','points':0});
level[1] =JSON.stringify({'name':'Level user','description':'Levels','points':10});
level[2] =JSON.stringify({'name':'Level mid','description':'Levels','points':25});
level[3] =JSON.stringify({'name':'Level dev','description':'Levels','points':40});
level[4] =JSON.stringify({'name':'Level geek','description':'Levels','points':60});
level[5] =JSON.stringify({'name':'Level master','description':'Levels','points':75});
...
badge[2] =JSON.stringify({'name':'badge mid','description':'badges','points':0,"URLBadge":  "http://www.4squarebadges.com/Portals/35599/images/foursquare-wino-badge.jpg.png"});
...
eventPoints[0] =JSON.stringify({'name':'First Post','description':'Event Points','eventId': 'firstPost', 'eventType':  'point','value':3});
eventPoints[1] =JSON.stringify({'name':'First Comment','description':'Event Points',"eventId": 'firstComment', 'eventType':  'point','value':3});
eventPoints[2] =JSON.stringify({'name':'Ten Post','description':'Event Points','eventId': 'TenPost', 'eventType':  'point','value':5});
eventPoints[3] =JSON.stringify({'name':'Ten Comment','description':'Event Points','eventId': 'TenComment', 'eventType':  'point','value':5});
